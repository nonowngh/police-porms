...
@Slf4j
@ComponentScan(basePackages = {"mb.fw.policeporms", "mb.fw.adaptor"})
public class PolicePormsApplication {
    public static void main(String[] args) throws Exception {
        ...
        SpringApplication.run(PolicePormsApplication.class, args);
    }
}
